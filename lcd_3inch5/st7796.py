...
class st7796():
    def __init__(self):
        ...
        self.GPIO_RST_PIN = DigitalOutputDevice(RST_PIN, active_high=True, initial_value=True)    # RST set as output: pin, high level active, default high
        self.GPIO_DC_PIN  = DigitalOutputDevice(DC_PIN, active_high=True, initial_value=True)     # DC set as output: pin, high level active, default high
        self.GPIO_BL_PIN  = PWMOutputDevice(BL_PIN, frequency=BL_Freq)                            # BL set as PWM: pin, PWM frequency
